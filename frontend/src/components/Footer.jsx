...
const Footer = () => {
  return (
    <footer className="w-fulpx-6 py-10 md:px-20 md:py-20 font-[Outfit]">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between pb-10 border-b border-gray-700 gap-8">
        
        <div className="flex flex-col gap-2">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">RentItNow</h2>
          <p>📞 +91 9876543210</p>
          <p>🏠 12 Street Name, Jorhat, India</p>
        </div>
