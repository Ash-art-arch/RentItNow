...
const Login = () => {
  ...
  <div className="gsi-material-button-content-wrapper">
    ...
    <span className="gsi-material-button-contents">Login in with Google</span>
    <span style={{ display: "none" }}>Login in with Google</span>
  </div>
</button>
<button className="microsoft-signin-button">
  ...
  <div className="microsoft-button-content-wrapper">
    ...
    <span className="microsoft-button-contents">Login with Microsoft</span>
    <span style={{ display: "none" }}>Login with Microsoft</span>
  </div>
</button>
</div>
</div>
